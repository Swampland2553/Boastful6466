...
\begin{frame}[fragile]
  ...
  \begin{block}{تجربه در عمل و مهارت‌های کاربردی}
    % Make all text in this block smaller
    \scriptsize
    \textbf{سوابق شغلی:}
    \begin{itemize}\setlength{\itemsep}{-3pt} % Further reduce spacing
    ...
    % Add negative space to move table upward
    \vspace{-0.5cm}

    % Use a centered table for skills and language instead of columns with smaller font
    \scriptsize % Even smaller than \small
    \begin{center}
      \begin{tabular}{r|r}
