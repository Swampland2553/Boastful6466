...
addQuestion({
    ...
    sections: {
        correctAnalysis: {
            ...
            content: `سیستم هدایت الکتریکی قلب یک مسیر یک‌طرفه، منظم و زمان‌بندی شده داره تا انقباض دهلیزها و بطن‌ها کاملاً هماهنگ باشه. مسیر درست به این شکله:
...
4. **انتشار در بطن‌ها:** بعد از تأخیر، پیام از طریق رشته‌های تخصصی هادی (دسته‌های هیس و رشته‌های پورکینژ) به سرعت در سراسر دیواره‌های ضخیم بطن‌ها پخش می‌شه و باعث **انقباض هماهنگ بطن‌ها** (از پایین به بالا) می‌شه.`,
            bookReference: `کتاب به وضوح به این مسیر اشاره می‌کنه: "گره اول یا گره سینوسی-دهلیزی... شروع‌کنندۀ پیام‌های الکتریکی است... پیام الکتریکی ایجاد شده در گره پیشاهنگ را به گره دوم منتقل می‌کند. پس از گره دهلیزی-بطنی، رشته‌هایی از بافت هادی... جریان الکتریکی را در بطن‌ها پخش می‌کنند." (صفحه ۵۲، شکل ۷ و متن)`
        },
        wrongOptions: {
            ...
            content: [
                {
                    option: "گزینه الف:",
                    explanation: "مسیر رو کاملاً برعکس و اشتباه نشون داده. انقباض از دهلیزها شروع می‌شه نه بطن‌ها."
                },
                {
                    option: "گزینه ج:",
                    explanation: "در این گزینه، انتشار پیام در دهلیزها و بطن‌ها بعد از عبور از هر دو گره ذکر شده که اشتباهه. پیام اول در دهلیزها پخش می‌شه، بعد به گره دوم می‌رسه و بعد در بطن‌ها پخش می‌شه."
                },
                {
                    option: "گزینه د:",
                    explanation: "ترتیب گره‌ها و انقباض اندام‌ها کاملاً اشتباهه."
                }
            ]
        },
        traps: {
            ...
            content: [
                {
                    trap: "تله بزرگ (تأخیر در گره AV):",
                    explanation: "مهم‌ترین نکته کنکوری این بخش، درک \"علت\" تأخیر در گره دهلیزی-بطنیه. این تأخیر برای هماهنگی انقباض و پر شدن کامل بطن‌ها ضروریه. طراح می‌تونه سوال بده که \"اگر پیام الکتریکی بدون تأخیر از دهلیز به بطن منتقل شود، چه اتفاقی می‌افتد؟\" پاسخ: برون‌ده قلبی کاهش می‌یابد چون بطن‌ها قبل از پر شدن کامل، منقبض می‌شوند."
                },
                {
                    trap: "تله مسیر:",
                    explanation: "قاطی کردن ترتیب گره‌ها و محل انتشار پیام، دام کلاسیک این مبحثه."
                }
            ]
        },
        advice: {
            title: "توصیه‌های مشاور:",
            content: `محمد جان، سیستم هادی قلب رو مثل یه دومینوی هوشمند در نظر بگیر. گره اول (SA) اولین مهره رو هل می‌ده و دومینوی دهلیزها می‌ریزه. بعد یه مانع کوچیک (گره AV) هست که باعث یه وقفه کوتاه می‌شه و بعد از اون وقفه، دومینوی بزرگ بطن‌ها می‌ریزه. این وقفه، کلید کارایی قلبه! این تصویرسازی بهت کمک می‌کنه ترتیب و دلیل هر مرحله رو به خاطر بسپری.`
        }
    }
});